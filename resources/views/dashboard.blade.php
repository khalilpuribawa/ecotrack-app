...
@section('content')
    <div class="p-5 mb-4 bg-light rounded-3">
        <div class="container-fluid py-5">
            <h1 class="display-5 fw-bold">Selamat Datang, {{ $user->name }}!</h1>
            <p class="col-md-8 fs-4">Poin Anda saat ini: <strong>{{ $user->points->total_points ?? 0 }}</strong>. Teruslah
                berkontribusi untuk bumi yang lebih baik.</p>
